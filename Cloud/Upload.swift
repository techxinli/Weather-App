    ...
    */
    func getMimeType() {
        ...
        guard let url = fileUrl else { return }
            ...
            if let ext:AnyObject = url.pathExtension as AnyObject?  {
            guard let UTI = UTTypeCreatePreferredIdentifierForTag(kUTTagClassFilenameExtension, ext as! CFString, nil) else { return }
